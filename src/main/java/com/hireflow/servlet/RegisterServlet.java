...
public class RegisterServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req,
        ...
        req.getRequestDispatcher(
                "/WEB-INF/views/register.jsp").forward(req, res);
    }
    ...
    protected void doPost(HttpServletRequest req,
        ...
        try {
            ...
            if (saved) {
                ...
                User created = userDAO.findByEmail(
    ...
    private String validate(String fullName, String email,
        ...
        if (role == null ||
                (!role.equals("seeker") && !role.equals("employer")))
            return "Please select a valid role.";
        return null; // all good
    }

    // ── Redirect after login/register ─────────────────
    static void redirectByRole(HttpServletResponse res,
                               HttpServletRequest req,
                               String role) throws IOException {
        String ctx = req.getContextPath();
        switch (role) {
            case "employer" ->
                    res.sendRedirect(ctx + "/dashboard/employer");
            case "admin" ->
                    res.sendRedirect(ctx + "/admin/panel");
            default ->
                    res.sendRedirect(ctx + "/dashboard/seeker");
        }
    }
}